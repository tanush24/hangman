#setting up the play game feature by defining as a function. This is done to be able to re-play the game as many times as you want.
def playGame():
    ...
    words = ['VISA','authorization','payments','clearing','interchange','settlement','issuer','acquirer','merchant','cardholder','consumer','commercial','fee','bank','tax','security','fraud','cybersource','cyber','developer','tester','software','tester','online','business','analyst','iterative','CV','currency','exchange','rates','interest','waterfall','agile','treasury']
    ...
    time.sleep(1)
    answer = input("Do you want to play again? Type 'yes' to play again or type anything else to quit. ").lower()
    if answer == 'yes':
